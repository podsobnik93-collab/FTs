  ...
  sh.innerHTML = `
    ...
    <div style="padding:16px 20px 24px;overflow-y:auto;max-height:70vh;">
      ...
      <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px;">
        <div class="sheet-field">
          <label>Ккал</label>
          <input type="number" id="new-recipe-kcal" placeholder="450" style="width:100%;padding:12px 14px;border-radius:12px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:15px;outline:none;" />
        </div>
        <div class="sheet-field">
          <label>Время (мин)</label>
          <input type="number" id="new-recipe-time" placeholder="25" style="width:100%;padding:12px 14px;border-radius:12px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:15px;outline:none;" />
        </div>
      </div>
      <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-bottom:16px;">
        <div class="sheet-field">
          <label>Белки (г)</label>
          <input type="number" id="new-recipe-protein" placeholder="48" style="width:100%;padding:12px 14px;border-radius:12px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:15px;outline:none;" />
        </div>
        <div class="sheet-field">
          <label>Жиры (г)</label>
          <input type="number" id="new-recipe-fat" placeholder="6" style="width:100%;padding:12px 14px;border-radius:12px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:15px;outline:none;" />
        </div>
        <div class="sheet-field">
          <label>Углеводы (г)</label>
          <input type="number" id="new-recipe-carbs" placeholder="42" style="width:100%;padding:12px 14px;border-radius:12px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:15px;outline:none;" />
        </div>
      </div>
...
(function() {
  window.openAddRecipeSheet = function() {
    ...
    sh.innerHTML = `
      ...
      <div style="padding:0 20px 24px;overflow-y:auto;max-height:76vh;">
        ...
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:10px;margin-bottom:12px;">
          <div class="sheet-field"><label>Ккал</label><input type="number" inputmode="decimal" min="0" id="new-recipe-kcal" placeholder="450" style="width:100%;padding:12px 14px;border-radius:12px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:15px;outline:none;" /></div>
          <div class="sheet-field"><label>Время (мин)</label><input type="number" inputmode="numeric" min="0" id="new-recipe-time" placeholder="25" style="width:100%;padding:12px 14px;border-radius:12px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:15px;outline:none;" /></div>
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:8px;margin-bottom:18px;">
          <div class="sheet-field"><label>Белки (г)</label><input type="number" inputmode="decimal" min="0" id="new-recipe-protein" placeholder="48" style="width:100%;padding:12px 10px;border-radius:12px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:15px;outline:none;" /></div>
          <div class="sheet-field"><label>Жиры (г)</label><input type="number" inputmode="decimal" min="0" id="new-recipe-fat" placeholder="6" style="width:100%;padding:12px 10px;border-radius:12px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:15px;outline:none;" /></div>
          <div class="sheet-field"><label>Углеводы (г)</label><input type="number" inputmode="decimal" min="0" id="new-recipe-carbs" placeholder="42" style="width:100%;padding:12px 10px;border-radius:12px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:15px;outline:none;" /></div>
        </div>
  ...
  window.addRecipeIngredientRow = function(name, grams) {
    ...
    row.innerHTML='<input class="new-recipe-ingredient-name" type="text" placeholder="Ингредиент" style="box-sizing:border-box;width:100%;height:44px;padding:10px 12px;border-radius:11px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:14px;outline:none;" />'+
      '<input class="new-recipe-ingredient-grams" type="number" inputmode="decimal" min="0" placeholder="грамм" style="box-sizing:border-box;width:100%;height:44px;padding:10px 8px;border-radius:11px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:14px;outline:none;text-align:center;" />'+
      '<button type="button" aria-label="Удалить ингредиент" style="width:36px;height:36px;padding:0;border:1px solid var(--border);border-radius:10px;background:var(--input-bg);color:#ef4444;font-size:21px;line-height:1;cursor:pointer;">×</button>';
    row.querySelector('.new-recipe-ingredient-name').value=name||'';
    row.querySelector('.new-recipe-ingredient-grams').value=grams||'';
    row.querySelector('button').onclick=function(){row.remove();}; list.appendChild(row);
  };
