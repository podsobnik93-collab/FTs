        ...
        <div class="diary-entry" style="position:relative;">
          <div style="display:flex;justify-content:space-between;align-items:flex-start;gap:8px;">
            ...
            <div style="display:flex;gap:4px;flex-shrink:0;">
              <button onclick="editDiaryFromCal('${d.id}','${dateStr}')" style="background:none;border:none;color:var(--accent);font-size:1rem;cursor:pointer;padding:2px 6px;border-radius:6px;line-height:1;" title="Редактировать">✏️</button>
              <button onclick="delDiaryFromCal('${d.id}','${dateStr}')" style="background:none;border:none;color:#ef4444;font-size:1rem;cursor:pointer;padding:2px 6px;border-radius:6px;line-height:1;" title="Удалить">🗑️</button>
            </div>
          </div>
