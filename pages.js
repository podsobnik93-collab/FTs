...
function showCalDay(dateStr) {
  ...
  let html='';
  if(calendarNote)html+=`<section class="cal-detail-block note"><div class="cal-detail-head"><span>Заметка</span><div class="cal-detail-actions"><button type="button" onclick="openCalendarNoteSheet('${dateStr}')">Изм.</button><button type="button" class="danger" onclick="deleteCalendarNote('${dateStr}')">Удалить</button></div></div><div class="cal-note-text">${escCalNote(calendarNote).replace(/\n/g,'<br>')}</div></section>`;
  if(dayDiary.length){
