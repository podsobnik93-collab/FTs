...
function showCalDay(dateStr) {
  ...
  if(waterAmount>0)html+=`<section class="cal-detail-block water"><div class="cal-detail-head"><span>Вода</span><small>${waterPct}%</small></div><div class="cal-water"><b>${waterAmount}</b><span>из ${waterGoal} мл</span></div><div class="cal-water-bar"><i style="width:${waterPct}%"></i></div></section>`;
