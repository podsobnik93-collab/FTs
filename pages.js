...
(function() {
  ...
  window.addRecipeIngredientRow = function(name, grams) {
    ...
    row.innerHTML=`<div class="new-recipe-ingredient-field"><label>Ингредиент</label><input class="new-recipe-ingredient-name" type="text" value="" autocomplete="off" style="box-sizing:border-box;width:100%;height:44px;padding:10px 12px;border-radius:11px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:14px;outline:none"></div><div class="new-recipe-ingredient-field"><label>Вес (г)</label><input class="new-recipe-ingredient-grams" type="number" value="" min="0" autocomplete="off" style="box-sizing:border-box;width:100%;height:44px;padding:10px 8px;border-radius:11px;border:1px solid var(--border);background:var(--input-bg);color:var(--text);font-size:14px;text-align:center;outline:none"><\/div><button type="button" aria-label="Удалить ингредиент" style="width:36px;height:36px;padding:0;border:1px solid var(--border);border-radius:10px;background:var(--input-bg);color:#ef4444;font-size:21px;line-height:1;cursor:pointer">×</button>`; list.appendChild(row);
  };
