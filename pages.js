...
// FITSIM BODY MEASUREMENTS SHEET — SWIPE DOWN TO CLOSE
(function () {
  'use strict';
  var attached = false;

  function attachBodySheetSwipe() {
    var sheet = document.getElementById('body-sheet');
  ...
  function tryAttach() {
    if (document.getElementById('body-sheet')) attachBodySheetSwipe();
  }
