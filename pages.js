...
/* FITSIM — правильный символ возврата в заголовке редактирования рецепта. */
(function(){
  var original = window.openRecipeEditor;
  if (typeof original !== 'function') return;
  window.openRecipeEditor = function(id){
    original(id);
    setTimeout(function(){
      var title = document.querySelector('#add-recipe-sheet .sheet-title button[onclick*="exitRecipeEditor"]');
      if (title) title.innerHTML = '‹ Изменить рецепт';
    }, 80);
  };
})();
