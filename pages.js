...
function attachGramsSheetGestures() {
  ...
  var ov = document.getElementById('grams-overlay');
  if (!sh || !ov) return;
  if (sh._gramsGesturesAttached) return;
  ...
  function onEnd() {
    ...
    if (delta > 80) {
      ...
      setTimeout(closeGramsSheet, 160);
    } else {
      sh.style.transform = 'translateY(0)';
    }
  }

  var handle = sh.querySelector('.sheet-handle') || sh;
