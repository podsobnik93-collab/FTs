...
function openRecipesPanel() {
  ...
  sh.addEventListener('touchmove', function(e){ if(!drag) return; cy=e.touches[0].clientY; var dy=Math.max(0,cy-sy); sh.style.transform='translateY('+dy+'px)'; },{passive:true});
