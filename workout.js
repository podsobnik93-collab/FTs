...
window.filterAddExSearch = function() {
  ...
  results.forEach(({ex, cat, idx}) => {
    html += `<div class="ex-pick-row" onclick="selectedAddCat='${cat}';selectAddExercise(${idx})" style="cursor:pointer;background:${selectedAddEx===ex?'var(--accent)':'transparent'};color:${selectedAddEx===ex?'#fff':'var(--text)'};border-radius:8px;padding:8px 12px;">
