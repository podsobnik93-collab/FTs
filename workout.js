...
function renderBuilderMuscleBack(){
  ...
  if(!btn){
    ...
    btn.textContent='‹  Все группы мышц';
...
function openAddExerciseSheet(){
  // Кнопка «+ Добавить» во время выполнения тренировки временно отключена.
  return;
}
