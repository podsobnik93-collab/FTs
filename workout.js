...
function renderAddMuscleBack(){
  ...
  let btn=document.getElementById('add-muscles-back');
  if(!btn){btn=document.createElement('button');btn.id='add-muscles-back';btn.type='button';btn.className='builder-muscles-back';btn.textContent='‹ Назад';btn.onclick=backToAddMuscleGroups;picker.insertBefore(btn,picker.firstChild);}
